...
I'm using [SLAM](https://github.com/stella-cv/stella_vslam) (see slam/run/src/calbration_challenge_slam.cc) to get the accumulated [pose](https://en.wikipedia.org/wiki/Pose_(computer_vision)) over the video.
...
I've achieved below 10% of error on the labeled set and 33% on the unlabeled set, above 25% but good enough for the Comma team to accept it.