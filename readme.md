...
I'm using [SLAM](https://github.com/stella-cv/stella_vslam) (see slam/src/calbration_challenge_slam.cc) to get the accumulated [pose](https://en.wikipedia.org/wiki/Pose_(computer_vision)) over the video.
